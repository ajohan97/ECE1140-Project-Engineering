...
public class Main<d> extends Application implements Track_Controller_HW_Interface {
    ...
    public void set_Block_State(int BlockNum, boolean occupancy) throws RemoteException {
        ...
        char[] reply1 = new char[1];
        try {
            reply1 = Arduino.ArduinoMessenger(message);
        } catch (IOException e) {
            e.printStackTrace();
        }
        System.out.println("I received back: " + new String(reply1));
        //System.out.println(reply1[0]);

        char[] reply2 = new char[1];
        try {
            reply2 = Arduino.ArduinoMessenger(message);
        } catch (IOException e) {
            e.printStackTrace();
        }
        System.out.println("I received back: " + new String(reply2));
        //System.out.println(reply2[0]);

        char[] reply3 = new char[1];
        try {
            reply3 = Arduino.ArduinoMessenger(message);
        } catch (IOException e) {
            e.printStackTrace();
        }
        System.out.println("I received back: " + new String(reply3));
       // System.out.println(reply3[0]);
